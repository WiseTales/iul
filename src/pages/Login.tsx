...
const Login = () => {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      if (response.ok) {
        navigate('/verify-otp', { state: { contact, type: contactMethod, isLogin: true } });
      } else {
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-8">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">Sign in to access your account</p>
          </CardHeader>
          <CardContent className="space-y-8 px-8 pb-8">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5"
            >
            ...
            <div className="text-center pt-4 border-t border-gray-100">
              <p className="text-gray-600">
                ...
                <Link to="/signup" className="text-blue-600 hover:text-blue-800 font-semibold hover:underline transition-all duration-200">
                  Create Account
                </Link>
              </p>
            </div>
